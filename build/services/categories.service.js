...
var CategoryService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, foundCategory];
                }
            });
        });
    };
    CategoryService.prototype.create = function (dataCategory) {
        return __awaiter(this, void 0, void 0, function () {
            var name, description, newCategory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = dataCategory.name, description = dataCategory.description;
    ...
    CategoryService.prototype.update = function (id, changes) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedCategory;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, db.category.delete({
                                where: { id: id },
                            })];
                    case 2:
