...
*/
export function UploadFile(fileObject, parentFolder) {
    return __awaiter(this, void 0, void 0, function () {
        var bufferStream, fileMetadata, media, response, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fileMetadata = {
                        name: "".concat(Date.now(), "-").concat(fileObject.name),
                ...
                case 1:
                    response = _a.sent();
                    data = response.data;
                    return [2 /*return*/, { name: data.name, url: data.webViewLink }];
            }
        });
    });
}
//# sourceMappingURL=get-key-google.js.map